<!--
 * @Date           : 2021-12-02 02:52:07
 * @FilePath       : /learning-space/src/pages/html/index.vue
 * @Description    : 
-->
<template>
  <div>
...
*/
let  relative_path='/books/html/md/'
 import {compute_config_base_on_require_context} from "src/boot/require-utils.js"
let { all_components, all_modules } =compute_config_base_on_require_context(require.context('public/books/html/md/', false, /\.md$/),'md',true)
