 ...
 * @FilePath       : /learning-space/src/pages/web/index.vue
 * @Description    : 
-->
...
*/
let  relative_path='/books/web/md/'
 import {compute_config_base_on_require_context} from "src/boot/require-utils.js"
let { all_components, all_modules } =compute_config_base_on_require_context(require.context('public/books/web/md/', false, /\.md$/),'md',true)
